...
## Current Production — automatic candidate research, September 22

Production serves exact `db465c1c57659233d4841f8679cca0aac3ecdd8f` through `dpl_CyDxyASkDk2HGGRwjDtCGqovtLQX` (`tenkings-backend-nextjs-41olp9f3x-ten-kings.vercel.app`). At September 22 15:36 UTC, all five actual Production aliases, project target and sole minute research cron verified on that artifact; 28 route/privacy checks and assets passed at build `HdwiGQMJw0yDYUgMuhh83`. Qualified stable main Preview remains the same source on `dpl_2VJgRGbJA1TUm9iikGZQvEX6WtLy` (`p6s7ca002`) with diagnostic execution disabled, including normal signed-in confirmation. Website and phone acceptance remain closed.

Automatic v6 research retrieves candidates from usable saved identity without requiring approved internal catalog coverage. Existing/future individual cards, including eligible loaded cards, remain in scope; bulk-origin units need exact individual descriptions and their own distinct original photos. Only recovery and bounded sale details are enabled. Full-resolution images, catalog consumers/contributions and paid diagnostics remain off. No new migration or host restart accompanied this release; its build explicitly skipped migrations. Selection still requires supported exact photo or catalog identity, printing/condition agreement, affirmative sold events, known USD prices and distinct listing images.

The first canonical snapshot at 15:36:24.434 UTC (SHA `d08fc7d71dc27c1c1acf7a1222766d13a4628ec714836c28a83d9bbb455d53e2`) preserved all 99 jobs, original results, inputs, descriptions and retry/attempt/recovery prefixes. It preceded new v6 work: 98 eligible individual cards, 11 ineligible shared-bulk units, zero v6 results and no appended attempts at that instant. This earlier preservation checkpoint remains unchanged.

**Latest canonical checkpoint — September 22, 15:48:10.922 UTC:** 98 eligible cards include nine current v6 results with 77 candidates, 50 assessed comparisons bound to retained image hashes, two matched assessments, zero selected comps and zero estimates. Eight of the nine results retain comparisons; two record an initial comparison failure and one an optional comparison failure. Failure markers can overlap retained comparisons: a completed job means a result was persisted, not that every model assessment succeeded. Thirty-six jobs now have the v2 recovery revision and 36 automatic refresh entries have been appended. Current statuses are 28 queued, one running, four pre-existing failed and 65 complete, including legacy results. All 99 original inputs and history prefixes and all 93 original result payloads remain preserved (84 current, nine in attempt history), with zero stale bindings or integrity failures. This is a dated, incomplete checkpoint; matched labels alone do not establish selected value or measured accuracy. See the [recovery plan](2026-09-21-inventory-research-recovery.md) for expanded receipt SHA `aaeb1d3d3567952d26fefb222c5517a6881da1a81fe4eb09fd50df17e6f20dd4` and dated follow-up evidence.

**The rollback boundary has now been crossed:** the latest snapshot contains persisted v2 recovery states and v6 results. A v2 claim can cross this boundary before paid research; legacy 6GK readers are incompatible. Roll forward with v6-compatible code and preserve all additive history. A newly qualified compatible recovery-disabled artifact pauses automatic recovery/queued refreshes but is not a global ordinary-research stop. No manual cron, history reset or blind rerun is authorized by this release.

## Historical source-search correction — September 21
