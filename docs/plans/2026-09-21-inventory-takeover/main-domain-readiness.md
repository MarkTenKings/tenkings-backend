...
**Current state at September 21, 20:54–20:57 UTC: main-domain rollout is live.** Production `dpl_2XUGoG74E88eVeFGETVzFkQDBhRC` is READY at exact source `9a12cd3591074dfe692976445fc30f51690ba043`; apex, www and collect resolve to this artifact. Public TLS/routing/assets, inherited specialist aliases, DNS preservation and natural minute-spaced cron HTTP 200 requests pass the independent postflight below. The stable main Preview subsequently advanced to the separate `2c8e0554` diagnostic candidate and qualified shutdown artifact `dpl_7Kbmt1fWpzWPuLVe6Ue3Xo7Pgiqm`; see the [current release record](../2026-09-16-main-only-release.md#september-21--qualified-combined-preview-and-diagnostic-shutdown). Production remains unchanged.
