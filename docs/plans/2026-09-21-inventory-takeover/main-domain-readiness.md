...
## Initial automatic recovery release — historical

**Initial release state: automatic Inventory recovery is live at exact source `6bfe43d81a2e16869a3f570d110959d40f8082dd`.** Production `dpl_5DmqXUVGtjUagX1oeKHBic1BYhV4` is READY at immutable host `tenkings-backend-nextjs-gig6dzjq7-ten-kings.vercel.app`. At **2026-09-22 03:02:36 UTC** (September 21 local), root verified apex, www, collect, both inherited platform aliases, the project Production target and the sole research cron on this artifact. Qualified main Preview is `dpl_23hGjdJQQ31J1iboZvQpiEZsGjcx`, immutable host `tenkings-backend-nextjs-g3q64ycuv-ten-kings.vercel.app`, from the same source.

Production passed **28 route/privacy checks and six assets** at build `zx4IFKyfqyJQiwnOAa9X5`; Preview passed **six routes and five assets** at build `6epgb__1r-4hykeB_4Ccj`. Source/DB/UI qualification passed **423 application tests and 21 PostgreSQL checks**. The additive recovery migration leaves **99 active entries and 13 historical rolled-back entries**, with every prior ledger row preserved and a verified no-op second deploy. Hosted builds skipped migrations. Production adds only `STAFF_INVENTORY_RESEARCH_RECOVERY_ENABLED=true`; optional catalog, contribution, image, sale-detail and diagnostic execution remains off. No DNS or ATLAS change belongs to this release.

The initial read-only audit at **2026-09-22 03:03:11 UTC** found that recovery created the two missing research jobs and checked four of the 92 unknown cards, all waiting for catalog evidence; 88 remained pending. All 97 prior jobs retained their manual-retry records and prior attempt prefixes. The automatic process covers future incomplete cards as well as the existing backlog; proposed details and unreviewed source suggestions do not become saved human facts or approved catalog evidence. This checkpoint establishes recovery activity, not improved estimate coverage. See the [recovery plan](../2026-09-21-inventory-research-recovery.md) and [current release record](../2026-09-16-main-only-release.md).

Later readback confirmed natural 03:02:37.319 and 03:03:37.220 UTC cron requests returned HTTP 200 on this exact new deployment. No manual cron invocation was made. Separate database outcomes establish recovery activity; the earlier cron requests below belong to dated historical deployments.

Mark confirmed phone testing complete and authorized the delivery lanes. That closes the old Preview phone gate. Mark subsequently confirmed that he reviewed the new website and it works. The website acceptance request is now closed on his confirmation. Do not repeat the phone/sign-in request or ask for generic release reapproval; this owner report does not manufacture new instrumented browser evidence. Sections marked pre-cutover are retained historical evidence, not outstanding deployment prerequisites.

This lane performs only source/retained-evidence reads, authenticated Vercel metadata/runtime-log reads, public DNS/HTTP GET/HEAD, auth OPTIONS and unsigned private-API auth-denial checks. This lane made no account/configuration, deployment, DNS, database, cron, business-record, provider-research, browser, shared-host or ATLAS mutation. Root performed the authorized rollout and owns integration and SESSION_LOG. Dated pre-cutover sections below retain their original evidence and are superseded by the current state above.

## Historical comp-review release — September 21 local / September 22 UTC

**Historical state: comp-value and staff-review release promoted at 2026-09-22 01:17:39 UTC (September 21 local time).** Production `dpl_FXLDCapouMhB7WtULnCTb45QXG31` is READY at exact source `bc92b1023640ab21499506fb2d4fb5e2bdb188df`, immutable host `tenkings-backend-nextjs-drrqyvmk1-ten-kings.vercel.app`. Root independently verified apex, www, collect and both inherited platform aliases on this artifact. Stable main Preview serves the same source through `dpl_Hie34Nkq8rhtp1MGjURUAsY7J8yH` (`hi22vdspr`). Both artifacts passed native Linux Sharp 0.34.5, 79-page build, Fluid 300-second and unsigned review/summary API privacy checks. Independent post-promotion proof passed all 28 route/privacy checks and six assets at exact build ID `BXAmDdh8X-Ikg6B_GxbR1`. The sole cron belongs to the promoted artifact, with a natural request returning HTTP 200 at 2026-09-22 01:18:37.171 UTC; this does not establish a job or research result. Private receipt `investigations/20260921-comp-review-release/postpromotion-independent-summary.json` has SHA-256 `9447954b4d67e2b8b4a776fe3f625b949ded69dee7f6a94e272297b7f87bcb6c`.

The separately qualified Inventory review migration passed: 98 active ledger entries, 13 historical rolled-back entries preserved, all prior entries preserved and a second migration deploy confirmed no-op. Hosted builds skipped migrations; optional catalog/enrichment/contribution/diagnostic flags remain off. No DNS or ATLAS change belongs to this release. The original domain rollout `9a12cd35` / `dpl_2XUG…`, its successful TLS/routing/assets/natural-cron evidence, and the earlier `2c8e0554` diagnostic/shutdown artifacts remain historical proof for those operations, not the current serving identities. See the [current release record](../2026-09-16-main-only-release.md).

Real estimate coverage remains zero in the retained research baseline. The aggregate describes 97 historical jobs: 92 complete V2 results, all unknown with zero reference records and unresolved identity, four failed and one superseded. It is not a count of unique active cards. The UI preserves retained research evidence and cannot confirm an empty original selection into a value. Catalog/printing reference coverage comes first, followed by qualified fresh research and sale/image-evidence qualification; see the [comp packet](comp-qualification.md).
