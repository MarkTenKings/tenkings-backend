...
Use the exact-source identities in [main-site release](../plans/2026-09-16-main-only-release.md), [Inventory delivery](../plans/2026-09-21-inventory-takeover/README.md) and [automatic recovery](../plans/2026-09-21-inventory-research-recovery.md). Current Production is `6bfe43d81a2e16869a3f570d110959d40f8082dd` / `dpl_5DmqXUVGtjUagX1oeKHBic1BYhV4`, immutable `tenkings-backend-nextjs-gig6dzjq7-ten-kings.vercel.app`; all five aliases / project target / sole cron verified September 22 03:02:36 UTC (September 21 local). Stable main Preview serves the same source through `dpl_23hGjdJQQ31J1iboZvQpiEZsGjcx` (`g3q64ycuv`). Prior bc92b102/FXL/Hie34 are historical comp-review release evidence. This release did not restart or deploy ATLAS.

Both exact-source 79-page / Linux Sharp 0.34.5 / Fluid 300 builds passed. Production 28 route / six asset postflight passed at build `zx4IFKyfqyJQiwnOAa9X5`; stable Preview six routes / five assets passed. The first two natural minute cron requests returned HTTP 200. Separate read-only canonical outcomes establish missing-job discovery and initial saved recovery assessments; request logs alone do not prove card results. Only `STAFF_INVENTORY_RESEARCH_RECOVERY_ENABLED=true` is enabled in Production. Optional catalog, sale-detail, full-resolution, contribution and diagnostic execution remain off. The separately qualified recovery migration passed with **99 active and 13 historical rolled-back entries**, exact old ledger/schema/research evidence preserved, and a no-op second deploy. Vercel builds skipped migrations.
