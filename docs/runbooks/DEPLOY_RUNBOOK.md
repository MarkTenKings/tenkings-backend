...
Current ATLAS release checkpoint — September 22, 2026 UTC: report/early-geometry source `79483f13000c23dfed62c0c03f1239beb8f74dfb` has qualified native/PG44 builds, applied only staff migrations43/44 with exact narrow grants, and started native container `aba32d6d…` / image `098a24a2…`. Caddy activation, all five control bindings, public promotion and final hosted checks are complete; the release is live. Use the [connected manual release runbook](../atlas/runbooks/CONNECTED_MANUAL_RELEASE.md) and [current audit](../atlas/audits/2026-09-22/report-early-geometry-release.md) for exact identities and consumed-action custody. Do not replay earlier actions or automatically restart the schema42 predecessor against schema44. Dated candidate/checkpoint claims below are historical.
