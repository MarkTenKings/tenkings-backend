...
Current ATLAS runtime — September 22, 2026 UTC: Back-geometry recovery source `053768aa4474f950017c43b659648668631f6b9e` is deployed and verified. Use the [connected manual release runbook](../atlas/runbooks/CONNECTED_MANUAL_RELEASE.md) for current image/container/web/control identities, consumed-action custody and actual evidence. No migration or grant accompanied this release. Dated candidate/checkpoint claims below are historical.
