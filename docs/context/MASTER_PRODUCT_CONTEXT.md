...
The consumer/staff main website is live at `https://tenkings.co`; www redirects to the main origin. Collect retains specialist tools and existing customer/card/NFC links. Exact Production source is `9a12cd3591074dfe692976445fc30f51690ba043`, deployment `dpl_2XUGoG74E88eVeFGETVzFkQDBhRC`. The sole inventory research schedule remains on that deployment. DNS/TLS, routing, private unsigned guards and six natural cron requests passed. Mark has confirmed both his previous phone test and the new website working; those owner acceptance items are complete as of September 21.

The Inventory lead uses `codex-staff-inventory-release-20260910`; main release uses `codex-main-site-release-20260916`. ATLAS grading remains separately owned. New Pokémon preparation, V4/V5 accuracy tooling and the private exact-input diagnostic are tested and included in the separately qualified main Preview candidate, but are not in the Production artifact above. One real Snivy diagnostic completed with retained private evidence and an unchanged saved research record; identity/value remained unresolved. Its execution flag is false in the qualified same-source shutdown Preview `dpl_7Kbmt1fWpzWPuLVe6Ue3Xo7Pgiqm`; the current delivery index records the evidence and remaining browser check. Optional catalog/research enrichment stays off pending its own qualified release and evidence. Current receipts and remaining work are indexed in [Inventory delivery](../plans/2026-09-21-inventory-takeover/README.md) and [main release](../plans/2026-09-16-main-only-release.md). The older general verification date and architecture history below are retained with their original scope.
