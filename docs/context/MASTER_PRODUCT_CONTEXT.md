...
The main website and staff Inventory are live at `https://tenkings.co`; www redirects to the main origin and collect retains specialist/customer/card/NFC links. Current Production is exact `6bfe43d81a2e16869a3f570d110959d40f8082dd`, deployment `dpl_5DmqXUVGtjUagX1oeKHBic1BYhV4` (`gig6dzjq7`), verified on all five Production aliases and the sole minute research cron at September 22 03:02:36 UTC (September 21 local). Postflight passed 28 route/privacy checks and six assets, build `zx4IFKyfqyJQiwnOAa9X5`. Stable main Preview is the same source through `dpl_23hGjdJQQ31J1iboZvQpiEZsGjcx` (`g3q64ycuv`), with six routes/five assets verified. Mark has accepted his phone test and new website; do not reopen those acceptance requests.
...
A fresh preactivation canonical replay confirmed 92 distinct current unknown cards, four failed cards and two missing jobs among 98 individual units, plus 11 excluded bulk units. The first two natural cron requests returned HTTP 200. The 03:04:20 UTC database audit proves the two missing jobs were created automatically and eight of the 92 received saved recovery assessments, all waiting for reviewed catalog evidence; 84 were not yet checked. Every original input/manual-retry/attempt prefix across all 97 baseline jobs was preserved; no estimate or new sold research attempt had been created at that observation. Recovery is active; complete backlog processing and qualified values must not be inferred from these initial results. The prior diagnosis remains: 18 cards lacked required lookup fields and the other 74 had no exact legacy set-alias hit. Narrow genuine catalog coverage and qualified sold evidence remain necessary. Current records are indexed in [Inventory delivery](../plans/2026-09-21-inventory-takeover/README.md) and [main release](../plans/2026-09-16-main-only-release.md).
