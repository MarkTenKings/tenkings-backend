...
| E2E | at least 1,000 deterministic simulated customer transactions plus crash/fault exploration; 72/125 local HTTP demo flows; actual production Next HTTP auth/events into disposable PostgreSQL for legacy150/72/125 | 500 observed real sessions; 5 purchase + 2 restock cycles for every door in the applicable approved profile |
