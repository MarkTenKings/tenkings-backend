...
The inspected Rev27 file at `/Users/markthomas/Downloads/Ten_Kings_Vault_Rev27_FINAL_QA/04_DIMENSIONED_4x10_SHEET_LAYOUTS/Final_Ten_Kings_Vault_Rev27_All_5_Sheets_DIMENSIONED.dxf` contains 100 rectangular openings in 5 columns by 20 rows, annotated 5.000 inches wide by 2.250 inches high, plus a TD1655 display opening and Nayax mounting notes. It is a five-sheet fabrication layout, not assembled-fit, electrical or controller-mapping proof. Mark subsequently selected it as the dimensional source for the 72-door review described above. The completed V72 Centered R01 design-review package now documents 72 doors in a 38.25 × 66.25 × 14-inch shell with a 6-inch cassette and three-sheet nesting; its stable software IDs and controller mappings are all null. The source/model/archive hashes and non-executable boundary are recorded in `MACHINE_PROFILES.md`. A native 125-door source remains unverified; the older Rev6 PDF describes different, smaller doors. No CAD file was edited by this software task.
