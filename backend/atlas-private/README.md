...
The release process binds exact committed source, image digest, required checks, provenance/signature and runtime admission. As of September 10, 2026, private C `89478881fe7e6dcf97637bdf7ff212e8b4e2b993` is root accepted and running: PR368 and main each passed all 14 checks, all 39 private tests passed, and the signed image digest is `3792bcb02bc5c6fdba22facb2614ec4e2d5b8ccd6d5cebee7d829b09588d811c`. Its container started at 13:25:20 UTC, passed health verification and all 15 private HTTPS/denial checks. CPU A2 `6b75c9399b83f55cca55045b560c205cbe91920b` remains admitted and unchanged. B's failed startup is historical evidence; its stopped container is retained under its archival name. Staff/public C are live for photo intake after read-only reconciliation of the committed controls without SQL replay and verified promotion of all four public aliases. Claims, preparation and paid grading remain inactive; final MacBook visual acceptance awaits desktop unlock. Exact bindings and remaining acceptance are in [the release checkpoint](../../docs/atlas/WEBSITE_RELEASE.md).
