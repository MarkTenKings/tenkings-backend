...
tests.testMacVendorListDoesNotResolveOrReadAnInterface()
tests.testMacVendorInspectUsesObservedInterfaceRegardlessOfOrder()
tests.testMacVendorAmbiguityAndOutOfSetResolutionNeverRead()
tests.testMacVendorPresenceFailuresStopBeforeConnectionOrRead()
...
print("{\"test\":\"swift_read_only_probe\",\"ok\":true,\"scenarios\":14}")
