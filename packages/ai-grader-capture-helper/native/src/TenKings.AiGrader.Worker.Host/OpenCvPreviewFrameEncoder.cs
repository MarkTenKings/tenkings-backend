...
internal sealed class OpenCvPreviewFrameEncoder(int quality = 85) : IPreviewFrameEncoder
{
    private readonly int _quality = quality is >= 1 and <= 100
        ? quality
    ...
    internal static PreviewJpeg EncodeBounded(Mat source, int requestedQuality, CancellationToken cancellationToken)
    {
