...
assert.deepEqual(Object.keys(pages).sort(), ['/', '/404', '/_app', '/_document', '/_error', '/api/staff/[...path]', '/cards/[cardId]', '/grading', '/operations', '/add-cards', '/workspace/[cardId]', '/manual', '/manual/[cardId]'].sort());
