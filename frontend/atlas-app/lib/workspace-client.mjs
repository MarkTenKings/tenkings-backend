...
const messages = {
    ...
    ASTRA_ABANDONMENT_AUTHORITY_REQUIRED: 'A fresh sign-in and recovery permission are required to continue this request.',
    ASTRA_ABANDONMENT_FRESH_OPERATIONS_REQUIRED: 'Sign in again with recovery permission, then review this request before continuing.',
    ASTRA_ABANDONMENT_NOT_AVAILABLE: 'This request changed or has a saved response. Refresh the card to review the current recovery options.',
    ASTRA_ABANDONMENT_REVIEW_CHANGED: 'The recovery details changed. Refresh the card and review them again before continuing.',
