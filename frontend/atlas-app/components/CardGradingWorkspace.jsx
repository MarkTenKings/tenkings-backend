...
export default function CardGradingWorkspace({ initial, staff, csrf, readiness }) {
    ...
    return <>
        ...
        {card.state === 'WAITING' && card.capabilities?.astraClaimUnavailableReason && <p className={styles.help} role="status">{workspaceMessage({ code: card.capabilities.astraClaimUnavailableReason })}</p>}
