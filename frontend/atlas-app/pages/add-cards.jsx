...
export default function AddCards({ unavailable, accessFailure, staff, manualEnabled }) { return unavailable ? <Unavailable accessFailure={accessFailure} /> : manualEnabled ? <BatchGrading staff={staff}/> : <IntakeLoader staff={staff} />; }
