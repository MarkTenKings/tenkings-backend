...
export default function AddCards({ unavailable, staff, manualEnabled }) { return unavailable ? <Unavailable /> : manualEnabled ? <ManualCards staff={staff}/> : <IntakeLoader staff={staff} />; }
