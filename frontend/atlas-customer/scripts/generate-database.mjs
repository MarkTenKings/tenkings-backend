...
const result = spawnSync(process.execPath, [resolve(app, 'node_modules/prisma/build/index.js'),
    'generate', '--schema', resolve(app, 'prisma/schema.prisma')], { cwd: app, stdio: 'inherit', env: {
    HOME: process.env.HOME, PATH: process.env.PATH,
    ATLAS_CUSTOMER_DATABASE_URL: 'postgresql://build:build@127.0.0.1:1/build?schema=atlas_customer',
