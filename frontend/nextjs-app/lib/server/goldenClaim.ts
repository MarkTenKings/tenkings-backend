...
import {
  ...
  GOLDEN_TICKET_MIN_AGE as DEFAULT_GOLDEN_TICKET_MIN_AGE,
} from "../goldenConsent";

export const GOLDEN_TICKET_CONSENT_TEXT_VERSION =
  process.env.GOLDEN_TICKET_CONSENT_TEXT_VERSION?.trim() || DEFAULT_GOLDEN_TICKET_CONSENT_TEXT_VERSION;
export const GOLDEN_TICKET_MIN_AGE = Number(process.env.GOLDEN_TICKET_MIN_AGE ?? DEFAULT_GOLDEN_TICKET_MIN_AGE);
export { GOLDEN_TICKET_COUNTDOWN_SECONDS, GOLDEN_TICKET_LIVE_SECONDS };
