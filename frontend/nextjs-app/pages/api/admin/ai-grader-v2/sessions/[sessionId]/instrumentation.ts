...
const details = z.object({
  ...
  geometryExecutionMode: z.literal("PARALLEL_SIDE_PIPELINES_V1").optional(),
  frontUploadDurationMs: z.number().int().min(0).max(10 * 60 * 1000).optional(),
  backUploadDurationMs: z.number().int().min(0).max(10 * 60 * 1000).optional(),
  frontGeometryDurationMs: z.number().int().min(0).max(10 * 60 * 1000).optional(),
  backGeometryDurationMs: z.number().int().min(0).max(10 * 60 * 1000).optional(),
